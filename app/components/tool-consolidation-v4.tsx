...
import { Check, X, AlertTriangle, ChevronRight, Info } from 'lucide-react';
...
export function ToolConsolidationV4() {
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid lg:grid-cols-[2fr,1fr] gap-6">
            ...
            >
              {/* Header */}
              <div className="px-5 py-3 bg-gray-50 dark:bg-zinc-800/50 border-b border-gray-200 dark:border-zinc-700">
            ...
            >
              {/* Current Stack Cost */}
              <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-700 shadow-lg overflow-hidden lg:sticky lg:top-8">
                <div className="px-5 py-3 bg-rose-50 dark:bg-rose-950/30 border-b border-rose-100 dark:border-rose-900">
                  <div className="flex items-center gap-2 text-xs font-medium text-rose-700 dark:text-rose-300 mb-0.5">
                    <X className="h-3.5 w-3.5" />
                    Your Current Stack
                  </div>
                  <p className="text-xs text-rose-600/70 dark:text-rose-400/70">
                    {selectedCount} {selectedCount === 1 ? 'tool' : 'tools'}, nothing connected
                  </p>
                </div>
              ...
              <div className="bg-white dark:bg-zinc-900 rounded-xl border-2 border-emerald-300 dark:border-emerald-700 shadow-lg overflow-hidden">
                <div className="px-5 py-3 bg-emerald-50 dark:bg-emerald-950/30 border-b border-emerald-100 dark:border-emerald-900">
                  <div className="flex items-center gap-2 text-xs font-medium text-emerald-700 dark:text-emerald-300 mb-0.5">
              ...
              <AnimatePresence>
                {totalCost > 149 && (
                  <motion.div
                    ...
                    className="bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl p-5 text-white shadow-xl"
                  >
